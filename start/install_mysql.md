...
```sql
-- 创建数据库
CREATE DATABASE IF NOT EXISTS eams4test CHARSET utf8mb4 COLLATE utf8mb4_0900_as_cs;
-- 创建用户
...
```sql
-- 创建数据库
CREATE DATABASE IF NOT EXISTS eams4prod CHARSET utf8mb4 COLLATE utf8mb4_0900_as_cs;
-- 创建用户
